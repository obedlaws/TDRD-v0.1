...
if answer.lower().strip() == "y":
        ...
        if answer == "1":
                ...
                answer = input("""
                You walk up into a crossroad that seems odly crated by nature. You see two
                road leading into the forest. From the right side you can hear a river and  from the left side
                road you can see a dark tunner created by 
                                [1. Go Right  2. Go Left  3. Get back and pick up the items]                      
                """)
